...
This folder contains a HyperFrames-ready 3-minute visual draft for the Kaggle demo video.
...
- `index.html` - HyperFrames project entrypoint.
- `narration_script.txt` - voiceover script extracted from `docs/video_script.md`.
...
```bash
npx hyperframes lint demo_video --verbose
npx hyperframes inspect demo_video --samples 12
npx hyperframes render demo_video --output demo_video/gemma_garden_guardian_demo_draft.mp4 --quality draft
```

For a lightweight rendered preview with audio, see:
